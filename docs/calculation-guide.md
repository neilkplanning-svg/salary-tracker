...
**רכיב "נטו-בלבד"** (רכיב שכל ה-flags שלו כבויים): **אינו** חלק מהברוטו **ואינו** חלק מהנטו — זהו כסף שאינו חלק מהתלוש (למשל הפקדה חודשית ל**קרן הדולרית**), המנוהל בנפרד במודול הקרן הדולרית. *(עדכון 2026-07: רכיב `researchDollar` הוסר מהקטלוג; הכסף הדולרי מוזן כהפקדה במסך "קרן דולרית", לא כרכיב שכר.)*
...
net = gross − incomeTax − nationalInsurance − healthTax − pension − pension2
      − trainingFund − otherDeductions − nonTaxableImputation
```
...
- **רכיבי "נטו-בלבד"** (§3.3) — **אינם** נכנסים לנטו; כסף שאינו בתלוש (קרן דולרית) מנוהל בנפרד.
